    ...
    SC_AGENT_IMPLEMENTATION(StudyReport)
            {
                    ...
                    for (int i=0; i<images.size(); i++){
                        ScIterator5Ptr metaIT = ms_context->Iterator5(images[i], ScType::EdgeDCommonConst,
                                                                      ...
                                                                      Keynodes::nrel_metadata_of_image);
                        ScAddr metadata;
                        while (metaIT->Next()) {
                        ...
                        ScIterator5Ptr projIT = ms_context->Iterator5(metadata, ScType::EdgeDCommonConst,
                                                                      ScType::Unknown, ScType::EdgeAccessConstPosPerm,
                                                                      Keynodes::nrel_projection);
                        ScAddr projection;
                        while (projIT->Next()) {
                        ...
                        ScIterator3Ptr pro_type = ms_context->Iterator3(ScType::Unknown, ScType::EdgeAccessConstPosPerm,
                                                                        projection);
                        while (pro_type->Next()) {
                        ...
                        ScIterator5Ptr latIT = ms_context->Iterator5(metadata, ScType::EdgeDCommonConst,
                                                                     ScType::Unknown, ScType::EdgeAccessConstPosPerm,
                                                                     Keynodes::nrel_laterality);
                        ScAddr laterality;
                        while (latIT->Next()) {
                        ...
                        ScIterator3Ptr lat_type = ms_context->Iterator3(ScType::Unknown, ScType::EdgeAccessConstPosPerm,
                                                                        laterality);
                        while (lat_type->Next()) {
                        ...
                        if (laterality_type.IsValid() && projection_type.IsValid()) {
                            ...
                            laterality_str = CommonUtils::getIdtfValue(ms_context.get(), laterality_type,
                                                                       Keynodes::nrel_main_idtf);
                            string projection_str = CommonUtils::getIdtfValue(ms_context.get(), projection_type,
                                                                              Keynodes::nrel_main_idtf);
                            string study_basic_report =
                                    "latrelity - " + laterality_str + "\n projection - " + projection_str;
                        ...
                        ScIterator5Ptr spatIT = ms_context->Iterator5(images[i], ScType::EdgeDCommonConst,
                                                                      ScType::Unknown, ScType::EdgeAccessConstPosPerm,
                                                                      Keynodes::nrel_spatial_artefacts);
                        ScAddr spatials;
                        while (spatIT->Next()) {
...
SC_LOG_INFO(spatials_report);
                        ...
                        ScIterator3Ptr artif = ms_context->Iterator3(spatials, ScType::EdgeAccessConstPosPerm,
                                                                     ScType::Unknown);
                        while (artif->Next()) {
                        ...
                        for (int j = 0; j < artifacts.size(); j++) {
                            ...
                            ScAddr artifact_type;
                            ScIterator3Ptr artifIT = ms_context->Iterator3(ScType::Unknown,
                            ...
                            if (artifact_type.IsValid()) {
                                ...
                                string artifact_str = CommonUtils::getIdtfValue(ms_context.get(), artifact_type,
                                                                                Keynodes::nrel_main_idtf);
                                ...
                                if (shape_type.IsValid()) {
                                    if (!ms_context->HelperCheckEdge(Left, shape_type,
                                                                     ScType::EdgeAccessConstPosPerm)) {
                                        ms_context->CreateEdge(ScType::EdgeAccessConstPosPerm, Left, shape_type);
                                    }
                                    string shape_str = CommonUtils::getIdtfValue(ms_context.get(), shape_type,
                                                                                 Keynodes::nrel_main_idtf);
                                    spatials_report = spatials_report + "\n shape - " + shape_str + " ";
                                }
                                //края
                                ...
                                ScIterator3Ptr margTypeIT = ms_context->Iterator3(ScType::Unknown,
                                                                                  ScType::EdgeAccessConstPosPerm, marg);
                                ...
                                if (marg_type.IsValid()) {
                                    ...
                                    string marg_str = CommonUtils::getIdtfValue(ms_context.get(), marg_type,
                                                                                Keynodes::nrel_main_idtf);
                                    spatials_report = spatials_report + "\n margins - " + marg_str + " ";
                                }
                                ...
                                ScIterator3Ptr denTypeIT = ms_context->Iterator3(ScType::Unknown,
                                                                                 ScType::EdgeAccessConstPosPerm, den);
                                ...
                                if (den_type.IsValid()) {
                                    ...
                                    string den_str = CommonUtils::getIdtfValue(ms_context.get(), den_type,
                                                                               Keynodes::nrel_main_idtf);
                                    spatials_report = spatials_report + "\n density - " + den_str + " ";
                                }
                                ...
                                ScIterator3Ptr distTypeIT = ms_context->Iterator3(ScType::Unknown,
                                                                                  ScType::EdgeAccessConstPosPerm, dist);
                                ...
                                if (dist_type.IsValid()) {
                                    ...
                                    string dist_str = CommonUtils::getIdtfValue(ms_context.get(), dist_type,
                                                                                Keynodes::nrel_main_idtf);
