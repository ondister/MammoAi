...
SC_PROPERTY(Keynode("question_probabilyty_counter"), ForceCreate)
static ScAddr question_probabilyty_counter;
...
SC_PROPERTY(Keynode("concept_nosological_form"), ForceCreate)
static ScAddr concept_nosological_form;

SC_PROPERTY(Keynode("nrel_attributes"), ForceCreate)
static ScAddr nrel_attributes;
